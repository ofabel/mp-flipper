...
#define MICROPY_PERSISTENT_CODE_LOAD (IS_RUNTIME)
#define MICROPY_PERSISTENT_CODE_SAVE (IS_COMPILER)
#define MICROPY_PERSISTENT_CODE_SAVE_FILE (0)

#define MICROPY_ENABLE_COMPILER (IS_COMPILER)
...
#define MICROPY_HELPER_REPL (IS_COMPILER)
